...
describe IndustrySpecificMarkup do
  ...
  describe '#total_value' do
    ...
    context 'when industry is pharmaceuticals' do
      ...
      it 'returns 7.5' do
        expect(subject.total_value(price, industry)).to eq(7.5)
      end
    end
    ...
    context 'when industry is electronics' do
      ...
      it 'returns 2' do
        expect(subject.total_value(price, industry)).to eq(2)
      end
    end
    ...
    context 'when industry is food' do
      ...
      it 'returns 13' do
        expect(subject.total_value(price, industry)).to eq(13)
      end
    end
    ...
    context 'when industry is something else' do
      ...
      it 'returns 0' do
        expect(subject.total_value(price, industry)).to eq(0)
      end
    end
  end
end
